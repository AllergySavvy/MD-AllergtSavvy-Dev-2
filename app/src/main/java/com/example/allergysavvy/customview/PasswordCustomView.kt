package com.example.allergysavvy.customview
...
class PasswordCustomView : AppCompatEditText, View.OnTouchListener {
    ...
    private fun init() {
        ...
        passImage = ContextCompat.getDrawable(context, R.drawable.baseline_vpn_key_24) as Drawable
    ...
    private fun showClearButton() {
        setButtonDrawables(startOfTheText = passImage, endOfTheText = clearButtonImage)
    }

    private fun hideClearButton() {
        setButtonDrawables(startOfTheText = passImage)
    }
