...
class NameCustomView : AppCompatEditText, View.OnTouchListener {
    ...
    private fun init() {
        ...
        personImage = ContextCompat.getDrawable(context, R.drawable.baseline_person_24) as Drawable
        ...
        addTextChangedListener(object : TextWatcher {
            ...
            override fun afterTextChanged(s: Editable) {
                if(s.toString().length > 35){
                    setError(context.getString(R.string.error_name), null)
                }else{
                    setError(null, null)
                }
            }
